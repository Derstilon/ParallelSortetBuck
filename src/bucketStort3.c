    ...
    int bucket_range)
{
    ...
    int *buckets = malloc(number_of_ranges * bucket_size * sizeof(int));
    double t0 = omp_get_wtime();
    int i = 0;
    int j = 0;
    int **bucket_tops = malloc(number_of_ranges * sizeof(int *));
    int *bucket_fullness = malloc(number_of_ranges * sizeof(int));
